        ...
        <div class="nameGl" v-for="thin in articleList" :key="thin.id">
            <div class="kmDnm">
              <div class="mlAsd">
                <a href="" class="nmgPls">
                  <div class="yspAsd">
                   <img :src="`${'http://u7w9jz.natappfree.cc' + thin.avatar}`" alt="" class="nmgHop">
                  </div>
                </a>
                <div class="yhMna">
                  <a href="#" class="fbnQin">
            ...
            <router-link to="details" href="#">
              ...
              <div class="npiAdd">
                <div class="ploAsd" v-for="app in thin.cover.slice(0,3)" :key="app">
                  <img :src="`${'http://u7w9jz.natappfree.cc' + app}`" alt="" width="100%" height="100%">
                </div>
              </div>
            </router-link>
            <div class="bhf">
    ...
    <div class="code">
      ...
      <div class="side">
        ...
        <div class="side-body">
          ...
          <div class="body-topic">
            <div class="topic-card">
              <img src="@/image/method/深境螺旋.jpeg" />
            </div>
            <div class="card-info">
              <p>深境螺旋</p>
            </div>
